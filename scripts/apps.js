...
loading();
function loading(){
    container.classList.add('none', 'show-nav', 'side-border') & container.classList.remove('side-clear');
...
open.addEventListener('click', ()=> 
    container.classList.add('show-nav', 'side-border') & container.classList.remove('side-clear') 
...
mobileAboutMenu.addEventListener('click', ()=>
    container.classList.remove('show-nav') & 
    container.classList.add('side-clear')
...
mobileSkillsMenu.addEventListener('click', ()=>
    container.classList.remove('show-nav') & 
    container.classList.add('side-clear')
)
...
mobileProjectsMenu.addEventListener('click', ()=>
    container.classList.remove('show-nav') & 
    container.classList.add('side-clear')
)
...
mobileExperienceMenu.addEventListener('click', ()=>
    container.classList.remove('show-nav') & 
    container.classList.add('side-clear')
)
